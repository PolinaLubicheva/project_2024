...
levels = [1, 2, 3]
counter_1 = 0 #переменная для прохода по ответам, подсказкам и вывода правильного вопроса
mist = 0 #счет ошибок в 1 уровне
mist_2 = 0 #счет ошибки в 2 уровне
counter_2 = 0 #переменная для прохода по ответам, подсказкам и вывода правильного вопроса
bag = []
...
if current_level == 1:
    ...
    while current_level == 1: #прохождение уровня до тех пор, пока не решит правильно или не поменяет уровень
        with open('test_1.txt','r', encoding='utf-8') as f1: #вопросы
            ...
            for line in lines:
                ...
                if per_ans != ans_1[counter_1]:
                    while mist < 3: #проверка на кол-во ошибок
                ...
                counter_1 += 1 #переход на строку, подсказку и ответ (для сравнения и вывода)
            if per_ans_1 == ans_1: #ответы сошлись
