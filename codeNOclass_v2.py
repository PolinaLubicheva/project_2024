    ...
    while current_level == 2:  # прохождение уровня до тех пор, пока не решит правильно или не поменяет уровень
        ...
        with open('test_2.txt', 'r', encoding='utf-8') as f2:  # задачи
            ...
            for line in lines:
                ...
                while attempts < 3:  # три попытки на ответ
                    ...
                    if per_ans == ans_2[counter_2]:
                        ...
                        if attempts < 3:  # если еще есть попытки
            ...
            if attempts < 3 and per_ans_2 == ans_2:  # если все ответы правильные
                ...
                if cont_ans.lower() == 'да':
                    ...
                    print('Хорошая работа! Отдохните!')
                    break
            elif attempts < 3:  # если тест завершен, но не все ответы правильные
                print('Тест завершен, где-то есть ошибка!')

if current_level == 3 and len(bag) > 0:
    # Уровень 3. ПЦР.
    print('Этап 1. Вам необходимо правильно рассчитать количество микролитров каждого реагента, которое необходимо добавить для проведения реакции (пример: буфер 0,1).')
    ...
    print('Этап 2. Подготовка пробы.поочередно добавляйте нужное количество каждого реагента в пробирку из расчета "нужное количество проб" + "одна запасная проба".')
    ...
    print('Запишите этап, его продолжительность (в минутах) и температуру для внесения данных в амплификатор:(пример ввода: элонгация 2 71)')
